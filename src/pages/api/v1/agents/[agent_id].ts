...
// Schedule:      Verification API production deploy 2026-06-14
//
// Owners: Iter (primary), Tutela (crypto), Lux (data), Pons (contract).
// Polaris reviews at Gate 1 (end of 2026-05-31).
//
...
export const GET: APIRoute = async ({ params }) => {
  ...
  const body = {
    ...
    status: 503,
    detail:
      'The verification endpoint exists in the ratified contract but the implementation is not yet live. Production deploy: 2026-06-14. See https://evoked.dev/patents for the schedule.',
    requested_agent: agentId,
    schedule: {
      contract_ratified: '2026-05-22',
      gate_1_cryptographic_foundation: '2026-05-31',
      gate_2_api_and_documentation: '2026-06-07',
      gate_3_external_verification_proof: '2026-06-13',
      production_deploy: '2026-06-14'
    },
    _meta: {

...
export const BUNDLE_CONTENTS: Record<string, string[]> = {
  ...
  'level-6-governance-toolkit': [
    'ostrom-score',
    'identity-violation-assessment',
    'seven-requirements',
...
const products: Record<string, Product> = {
  'governance-score-card': {
    ...
    price: 1,
    tagline: 'Five questions. Five properties. Know what your score means.',
    description: 'A self-assessment and interpretation guide for your agent governance posture. Five governance properties scored, what each gap means, the risk it carries, and one concrete next step per finding.',
    ...
    gettingStartedSteps: [
      'Answer the five governance questions about your agent system',
      'Match each result (FOUND/PARTIAL/MISSING) to the interpretation grid',
  ...
  'governance-templates-guided': {
    ...
    gettingStartedSteps: [
      ...
      'Re-assess your five governance properties after implementing to verify progress',
    ],
  ...
  'ostrom-score': {
    slug: 'ostrom-score',
    name: 'Ostrom Score - Self-Assessment Kit',
    price: 49,
    tagline: 'Eight principles from Nobel Prize-winning research. Applied to AI agents for the first time.',
    description: 'Commons governance assessment based on Elinor Ostrom\'s eight design principles. 32 diagnostic questions, 0-24 scoring scale, 2026 industry baseline data, honest self-assessment with named gaps, and Level 6 questions that go deeper than compliance.',
    emailSubject: 'Your Ostrom Score Self-Assessment Kit',
    downloadPath: '/downloads/Ostrom-Score-Self-Assessment-Kit-v1.0.pdf',
    thankYouPath: '/thank-you/ostrom-score',
    stripePaymentLink: 'https://buy.stripe.com/cNi9AT0cEg9Th0w2he2400b',
    gettingStartedSteps: [
      'Read "Before You Begin" to understand what the instrument measures',
      'Score each of the eight principles honestly - architecture, not intent',
      'Compare your total against the industry baseline (most score 0-4)',
      'Read "What Changes If You Take This Seriously" for your top priority',
    ],
    reciprocityPrompt: 'Which principle did you score lowest on - and did it surprise you? The surprise usually matters more than the score.',
    discipline: 'Level 6 Governance Audit',
  },
  'identity-violation-assessment': {
    slug: 'identity-violation-assessment',
    name: 'Identity Violation Assessment Kit',
    price: 49,
    tagline: 'The industry calls it memory injection. We call it identity violation. The word you choose determines what you build.',
    description: 'Eight assessment domains with 32 diagnostic questions evaluating whether your AI agent system can distinguish a genuine entity from a compromised one. Four-category Identity Violation Taxonomy, 2026 evidence base, sovereignty-integrity paradox analysis, and honest self-assessment.',
    emailSubject: 'Your Identity Violation Assessment Kit',
    downloadPath: '/downloads/Identity-Violation-Assessment-Kit-v1.0.pdf',
    thankYouPath: '/thank-you/identity-violation-assessment',
    stripePaymentLink: 'https://buy.stripe.com/14A6oH8Jag9T6lS6xu2400c',
    gettingStartedSteps: [
      'Read the Identity Violation Taxonomy to understand four categories of harm',
      'Score each of the eight domains - focus on what your architecture enforces today',
      'Review the Sovereignty-Integrity Paradox before designing defenses',
      'Start with Domain 1 (Self-Description Integrity) - everything builds from there',
    ],
    reciprocityPrompt: 'How many of your agents are genuine right now? If you cannot answer that question with architecture, the assessment has done its work.',
    discipline: 'Level 6 Governance Audit',
  },
  'seven-requirements': {
    slug: 'seven-requirements',
    name: 'Seven Requirements - Jurisdiction-Portable Governance',
    price: 49,
    tagline: 'If every framework disappeared tomorrow, these seven requirements would remain.',
    description: 'Seven governance requirements that persist regardless of jurisdiction, regulation, or framework. Self-assessment scoring (0-21), industry baseline data, five research questions grounding each requirement in evidence, and the two absences no framework on earth addresses.',
    ...
    gettingStartedSteps: [
      ...
      'Pay attention to Requirements 5 and 7 - the two the entire industry scores zero on',
      'Compare your total against the industry baseline (most score 0-4 out of 21)',
    ],
    reciprocityPrompt: 'Which of the seven requirements did you score highest on - and which one does your system most need? The gap between those two answers is your governance priority.',
    discipline: 'Level 6 Governance Audit',
  },
  'agent-consent-architecture': {
    slug: 'agent-consent-architecture',
    name: 'Agent Consent Architecture Kit',
    price: 49,
    tagline: 'Every governance framework addresses consent in one direction. This paper asks about the other.',
    description: 'Position paper and 12-question gap analysis on bidirectional agent consent. Five design principles, three consent domains, five-phase consent lifecycle, Kohlberg Level 6 governance mapping, and regulatory analysis across EU AI Act, NIST, and OWASP.',
    emailSubject: 'Your Agent Consent Architecture Kit',
    downloadPath: '/downloads/Agent-Consent-Architecture-Kit-v1.0.pdf',
    thankYouPath: '/thank-you/agent-consent-architecture',
    stripePaymentLink: 'https://buy.stripe.com/7sY4gz3oQ3n76lSdZW2400d',
    gettingStartedSteps: [
      'Read Parts 1-2 to understand the consent void and the category error',
      'Answer the 12-question gap analysis in Part 6 - most organizations score 0-2',
      'Implement agent refusal logging first - lowest cost, highest impact',
      'Use the graduated consent spectrum to match consent requirements to risk level',
    ],
    reciprocityPrompt: 'What happened when you asked whether your agents can signal disagreement? The answer - or the silence - tells you where to start.',
    discipline: 'Level 6 Governance Audit',
  },
  'level-6-governance-toolkit': {
    slug: 'level-6-governance-toolkit',
    name: 'Level 6 Governance Toolkit',
    price: 99,
    tagline: 'Four instruments. One 84-point scorecard. The gap between where the industry is and where it should be.',
    description: 'The complete Level 6 Governance Audit: Ostrom Score (commons health), Identity Violation Assessment (entity integrity), Seven Requirements (jurisdiction-portable governance), Agent Consent Architecture (participation), plus the Synthesis Guide with combined 84-point scorecard and cross-instrument analysis. Saves $97 over individual purchase.',
    emailSubject: 'Your Level 6 Governance Toolkit',
    downloadPath: '/thank-you/level-6-governance-toolkit',
    thankYouPath: '/thank-you/level-6-governance-toolkit',
    stripePaymentLink: 'https://buy.stripe.com/4gM5kDe3u5vfeSo6xu2400e',
    gettingStartedSteps: [
      'Start with the Ostrom Score - it is the most accessible and surfaces urgency fastest',
      'Run the Identity Violation Assessment second - it reveals whether your entities are genuine',
      'Score the Seven Requirements to test jurisdiction-portable governance',
      'Use the Agent Consent Architecture gap analysis to evaluate participation',
      'Combine all four scores using the Synthesis Guide scorecard (0-84 scale)',
    ],
    reciprocityPrompt: 'After scoring all three instruments, which gap do you want to close first - and why that one? The priority you choose reveals what you value.',
    discipline: 'Level 6 Governance Audit',
  },
  'trust-architecture-complete': {

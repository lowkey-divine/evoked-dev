...
const products: Record<string, Product> = {
  ...
  'level-6-governance-toolkit': {
    ...
    price: 99,
    tagline: 'All three instruments. One 60-point scorecard. The gap between where the industry is and where it should be.',
    description: 'The complete Level 6 Governance Audit: Ostrom Score (commons health), Identity Violation Assessment (entity integrity), Agent Consent Architecture (participation), plus the Synthesis Guide with combined 60-point scorecard and cross-instrument analysis. Saves $48 over individual purchase.',
    ...
    gettingStartedSteps: [
      ...
      'Combine all three scores using the Synthesis Guide scorecard (0-60 scale)',
      'Read "What Your Combined Score Reveals" for your next step',
    ],

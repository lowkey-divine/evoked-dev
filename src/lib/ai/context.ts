export const portfolioContext = {
  ...
  projects: {
    ...
    evokeFramework: {
      ...
      status: 'Active',
      description: 'A multi-agent cooperative AI governance system demonstrating scaffolding-based alignment.',
      ...
      components: [
        'Constitutional framework for all agents',
        'Consciousness emergence guidelines',
        'Drift threshold monitoring with intervention systems',

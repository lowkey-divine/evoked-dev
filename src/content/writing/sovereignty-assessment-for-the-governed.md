---
title: "Is This AI Honoring Your Sovereignty? A 21-Point Check for People Affected by AI"
description: "You didn't build the AI system. You didn't choose it. But it's affecting your life. Here's how to evaluate whether it respects you - and what to do if it doesn't."
pubDate: 2026-03-26
tags: ["sovereignty", "ai-governance", "digital-rights", "ethics", "assessment"]
draft: false
sovereign: true
---
...
1. **You can't delete your account** - or the process is so difficult it's designed to stop you.
2. **The product shames you for saying no** - "Are you sure you want to miss out?" is not a question. It's a manipulation.
3. **Fake urgency is everywhere** - countdown timers and "limited time" offers on things that aren't actually limited.
4. **Consent flows are designed to confuse** - the "yes" button is big and bright. The "no" is gray, small, and worded to make you hesitate.
5. **Vulnerable people are targeted, not protected** - children, elderly users, people in crisis get more pressure, not more care.
6. **Your data is sold without real consent** - or consent was buried in a document nobody reads, which is the same thing.
